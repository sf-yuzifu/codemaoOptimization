...
11. 可自定义CSS样式
12. 论坛发表情包时不乱码
13. 一键清除铃铛内未读消息（强迫症狂喜）
14. **实验性** 论坛自动翻页
15. 消息页面自动加载更多
16. 消息页面防吞头像
17. 暗黑模式96%接入（可自由挑选亮色/暗色/跟随系统）
18. 修改favicon图标为更好看的编程猫
19. 修改title排版
20. 修复论坛双滑动条问题
21. 检查作品是否有人再创作作品并发布
22. 404页面自动跳转到首页
23. **较为完善的**防劫持系统，移除在iframe中cookies的读取
24. 可自定义导航栏“编程猫”文字【默认为“PICKCAT”（快点发布！）】
25. 登录用户名设置（仅限一次）
26. 铃铛实时消息数提醒
27. 点赞数/粉丝数实时推送（需挂着至少一个编程猫界面）
28. 为导航栏做了一点小屏适配
29. 论坛帖子界面图片以画廊形式显示
30. 海龟/CoCo作品可以投稿至工作室
31. 评论区广告清除
